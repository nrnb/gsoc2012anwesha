...
/**
 * Calculates pathway statistics and exports 
 * html pages for the list of pathways ranked 
...
public class StatExportHandler {
	...
	public String testStatHandler(){
		return "it works!";
	}
	
	// call locally from R or GenePattern
	public String calculatePathwayStatistics (String gexFile, String dbFile, String pathDir, 
			String exprZ, String output) throws Exception {
		return xportInfo(gexFile, dbFile, pathDir, exprZ, output, false, "");
	}
	
	// call from a web portal
	public String xportInfo (String gexFile, String dbFile, String pathDir, String exprZ, 
			String output, boolean fromWeb, String webAddress) throws Exception {
